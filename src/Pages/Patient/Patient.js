...
const Form = () => {
    ...
    const handleSubmit = () => {
        dispatch(addPatient({ id, name, address, phone, department, birth: `${birth.year}/${birth.month}/${birth.day}`, gender, age, updateTime: new Date() }));
    };
    ...
    return (
        <Box className={classes.formContainer}>
            ...
            <Box className={classes.tableBody}>
                <DatePicker value={birth} onChange={setBirth} inputPlaceholder="選擇生日" shouldHighlightWeekends renderInput={DatePickerCustomInput} />
                <GenderPicker />
            </Box>
            <Box sx={{ display: 'flex', justifyContent: 'center' }}>
                ...
                <Button variant="contained" className={classes.button} color="secondary" sx={{ color: theme.palette.primary.main }} onClick={handleDelete}>
                    清除
                </Button>
            </Box>
