...
const columns = [
    ...
    { field: 'time', headerName: '時間', type: 'dateTime', width: 300, editable: true },
];

const rows = [
    { id: 'A000000001', doctor: '楊醫師', name: 'Lannister', age: 42, time: '1700-1800' },
    { id: 'A000000000', doctor: '李醫師', name: 'Snow', age: 35, time: '1700-1800' },
    { id: 'A000000002', doctor: '張醫師', name: 'Lannister', age: 45, time: '1400-1500' },
    { id: 'A000000003', doctor: '李醫師', name: 'Stark', age: 16, time: '1700-1800' },
    { id: 'A000000004', doctor: '楊醫師', name: 'Targaryen', age: 62, time: '1700-1800' },
    { id: 'A000000005', doctor: '張醫師', name: 'Melisandre', age: 150, time: '1300-1400' },
    { id: 'A000000006', doctor: '李醫師', name: 'Clifford', age: 44, time: '1700-1800' },
    { id: 'A000000007', doctor: '楊醫師', name: 'Frances', age: 36, time: '1700-1800' },
    { id: 'A000000008', doctor: '李醫師', name: 'Roxie', age: 65, time: '1700-1800' },
    { id: 'A000000009', doctor: '楊醫師', name: 'Roxie', age: 65, time: '1700-1800' },
    { id: 'A000000010', doctor: '張醫師', name: 'Roxie', age: 65, time: '1700-1800' },
];
